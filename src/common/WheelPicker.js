  ...
  render() {
    ...
    return (
      <View
        ...
        width={width}
        height={this.props.wallet && this.props.height}
        {...rest}
      >
        {this.state.valueSet && this.props.placeholder && !this.props.wallet ? (
          <View
            marginHorizontal={8}
            paddingHorizontal={3}
            borderRadius={10}
          ...
          >
            <Text color="#8A8A8A" size={0.8 * size}>
              {this.props.placeholder}
            </Text>
          </View>
        ) : null}
        ...
        >
          ...
          <View
            ...
            center={this.props.wallet}
            // stretch={this.props.wallet}
          >
            {this.props.wallet ? (
              <Text color="white" size={size} mh={3}>
                {this.props.placeholder}
              </Text>
            ) : (
              <Text
